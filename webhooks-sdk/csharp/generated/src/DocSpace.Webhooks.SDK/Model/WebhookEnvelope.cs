...
namespace DocSpace.Webhooks.SDK.Model
{
    ...
    public partial class WebhookEnvelope : IValidatableObject
    {
        ...
        /// <param name="payload">Trigger-specific body. Left untyped so that codegen stays clean in all 9 target languages; the runtime narrows it. .</param>
        /// <param name="webhook">webhook.</param>
        public WebhookEnvelope(WebhookEventInfo varEvent = default, Object payload = default, WebhookConfigInfo webhook = default)
        {
            this.Event = varEvent;
        ...
        public WebhookEventInfo Event { get; set; }

        /// <summary>
        /// Trigger-specific body. Left untyped so that codegen stays clean in all 9 target languages; the runtime narrows it. 
        /// </summary>
        /// <value>Trigger-specific body. Left untyped so that codegen stays clean in all 9 target languages; the runtime narrows it. </value>
        ...
        public WebhookConfigInfo Webhook { get; set; }
