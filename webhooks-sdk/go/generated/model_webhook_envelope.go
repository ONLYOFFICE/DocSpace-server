...
// checks if the WebhookEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookEnvelope{}

// WebhookEnvelope The body of every delivery. `payload` is narrowed by `event.trigger` per x-docspace-trigger-payloads. 
type WebhookEnvelope struct {
	Event *WebhookEventInfo `json:"event,omitempty"`
	// Trigger-specific body. Left untyped so that codegen stays clean in all 9 target languages; the runtime narrows it. 
	Payload interface{} `json:"payload,omitempty"`
	Webhook *WebhookConfigInfo `json:"webhook,omitempty"`
}
...
// SetEvent gets a reference to the given WebhookEventInfo and assigns it to the Event field.
...
// SetWebhook gets a reference to the given WebhookConfigInfo and assigns it to the Webhook field.
func (o *WebhookEnvelope) SetWebhook(v WebhookConfigInfo) {
	o.Webhook = &v
}

func (o WebhookEnvelope) MarshalJSON() ([]byte, error) {
...
func (o WebhookEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableWebhookEnvelope struct {
	value *WebhookEnvelope
	isSet bool
}

func (v NullableWebhookEnvelope) Get() *WebhookEnvelope {
	return v.value
}

func (v *NullableWebhookEnvelope) Set(val *WebhookEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookEnvelope(val *WebhookEnvelope) *NullableWebhookEnvelope {
	return &NullableWebhookEnvelope{value: val, isSet: true}
}

func (v NullableWebhookEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
