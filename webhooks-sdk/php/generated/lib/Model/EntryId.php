...
/**
 * EntryId Class Doc Comment
 *
 * @category Class
 * @description Entry identifier. Generic T in the domain types: integer for entries in DocSpace&#39;s own storage, string for entries backed by a third-party provider. Both occur on the same portal.
 * @package  OnlyOffice\DocSpace\Webhooks\Sdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EntryId implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EntryId';
