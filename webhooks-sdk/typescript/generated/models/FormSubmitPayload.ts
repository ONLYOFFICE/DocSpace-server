...
import type { FileEntryPayload } from './FileEntryPayload';
import {
    FileEntryPayloadFromJSON,
    FileEntryPayloadFromJSONTyped,
    FileEntryPayloadToJSON,
    FileEntryPayloadToJSONTyped,
} from './FileEntryPayload';
...
export interface FormSubmitPayload {
     ...
     * 
     */
    originalForm?: FileEntryPayload;
    /**
     * 
     */
    submittedForm?: FileEntryPayload;
}

/**
 * Check if a given object implements the FormSubmitPayload interface.
 */
export function instanceOfFormSubmitPayload(value: object): value is FormSubmitPayload {
    return true;
}

export function FormSubmitPayloadFromJSON(json: any): FormSubmitPayload {
    return FormSubmitPayloadFromJSONTyped(json, false);
}

export function FormSubmitPayloadFromJSONTyped(json: any, ignoreDiscriminator: boolean): FormSubmitPayload {
    if (json == null) {
        return json;
    }
    return {
        
        'originalForm': json['originalForm'] == null ? undefined : FileEntryPayloadFromJSON(json['originalForm']),
        'submittedForm': json['submittedForm'] == null ? undefined : FileEntryPayloadFromJSON(json['submittedForm']),
    };
}

export function FormSubmitPayloadToJSON(json: any): FormSubmitPayload {
    return FormSubmitPayloadToJSONTyped(json, false);
}

export function FormSubmitPayloadToJSONTyped(value?: FormSubmitPayload | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'originalForm': FileEntryPayloadToJSON(value['originalForm']),
        'submittedForm': FileEntryPayloadToJSON(value['submittedForm']),
    };
}
