...
import type { WebhookEventInfo } from './WebhookEventInfo';
import {
    WebhookEventInfoFromJSON,
    WebhookEventInfoFromJSONTyped,
    WebhookEventInfoToJSON,
    WebhookEventInfoToJSONTyped,
} from './WebhookEventInfo';
import type { WebhookConfigInfo } from './WebhookConfigInfo';
import {
    WebhookConfigInfoFromJSON,
    WebhookConfigInfoFromJSONTyped,
    WebhookConfigInfoToJSON,
    WebhookConfigInfoToJSONTyped,
} from './WebhookConfigInfo';
...
/**
 * Check if a given object implements the WebhookEnvelope interface.
 */
export function instanceOfWebhookEnvelope(value: object): value is WebhookEnvelope {
    return true;
}

export function WebhookEnvelopeFromJSON(json: any): WebhookEnvelope {
    return WebhookEnvelopeFromJSONTyped(json, false);
}

export function WebhookEnvelopeFromJSONTyped(json: any, ignoreDiscriminator: boolean): WebhookEnvelope {
    if (json == null) {
        return json;
    }
    return {
        
        'event': json['event'] == null ? undefined : WebhookEventInfoFromJSON(json['event']),
        'payload': json['payload'] === undefined ? undefined : json['payload'] === null ? null : json['payload'],
        'webhook': json['webhook'] == null ? undefined : WebhookConfigInfoFromJSON(json['webhook']),
    };
}

export function WebhookEnvelopeToJSON(json: any): WebhookEnvelope {
    return WebhookEnvelopeToJSONTyped(json, false);
}

export function WebhookEnvelopeToJSONTyped(value?: WebhookEnvelope | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'event': WebhookEventInfoToJSON(value['event']),
        'payload': value['payload'],
        'webhook': WebhookConfigInfoToJSON(value['webhook']),
    };
}
