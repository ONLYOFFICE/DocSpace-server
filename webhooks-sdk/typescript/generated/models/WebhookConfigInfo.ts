...
import type { WebhookTargetInfo } from './WebhookTargetInfo';
import {
    WebhookTargetInfoFromJSON,
    WebhookTargetInfoFromJSONTyped,
    WebhookTargetInfoToJSON,
    WebhookTargetInfoToJSONTyped,
} from './WebhookTargetInfo';
...
/**
 * Check if a given object implements the WebhookConfigInfo interface.
 */
export function instanceOfWebhookConfigInfo(value: object): value is WebhookConfigInfo {
    return true;
}

export function WebhookConfigInfoFromJSON(json: any): WebhookConfigInfo {
    return WebhookConfigInfoFromJSONTyped(json, false);
}

export function WebhookConfigInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): WebhookConfigInfo {
    if (json == null) {
        return json;
    }
    return {
        ...
        'target': json['target'] == null ? undefined : WebhookTargetInfoFromJSON(json['target']),
        'lastFailureOn': json['lastFailureOn'] == null ? undefined : (parseDateTime(json['lastFailureOn'])),
        'lastFailureContent': json['lastFailureContent'] == null ? undefined : json['lastFailureContent'],
        'lastSuccessOn': json['lastSuccessOn'] == null ? undefined : (parseDateTime(json['lastSuccessOn'])),
        'retryCount': json['retryCount'] == null ? undefined : json['retryCount'],
        'retryOn': json['retryOn'] == null ? undefined : (parseDateTime(json['retryOn'])),
    };
}

export function WebhookConfigInfoToJSON(json: any): WebhookConfigInfo {
    return WebhookConfigInfoToJSONTyped(json, false);
}

export function WebhookConfigInfoToJSONTyped(value?: WebhookConfigInfo | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'target': WebhookTargetInfoToJSON(value['target']),
        'lastFailureOn': value['lastFailureOn'] == null ? value['lastFailureOn'] : serializeDateTime(value['lastFailureOn']),
        'lastFailureContent': value['lastFailureContent'],
        'lastSuccessOn': value['lastSuccessOn'] == null ? value['lastSuccessOn'] : serializeDateTime(value['lastSuccessOn']),
        'retryCount': value['retryCount'],
        'retryOn': value['retryOn'] == null ? value['retryOn'] : serializeDateTime(value['retryOn']),
    };
}
