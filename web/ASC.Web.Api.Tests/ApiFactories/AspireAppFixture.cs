...
/// <summary>
/// The Web.Api suite's Aspire host: Web.Api itself is always started by the base fixture,
/// so only People is added — for the members and guests a test invites.
/// </summary>
public class AspireAppFixture : AspireHostFixture<PortalClients>
{
    protected override IEnumerable<string> Resources => [ResourceNames.People];
