...
/// <summary>
/// POST /api/2.0/settings/aiagentquotasettings — the portal's default AI agent storage quota.
/// Only Owner and DocSpaceAdmin may change it.
/// </summary>
[Trait("Category", "Settings")]
public class AiAgentQuotaSettingsTests(
    ...
    : BaseTest(fixture)
{
    ...
    [Fact]
    public async Task SaveAiAgentQuotaSettings_Owner_DisablesQuota()
    {
        // Arrange
    ...
    [Fact]
    public async Task SaveAiAgentQuotaSettings_Owner_EnablesQuotaWithSize()
    {
        // Arrange
        await _webApiClient.Authenticate(Owner);
    ...
    [Fact]
    public async Task SaveAiAgentQuotaSettings_DocSpaceAdmin_DisablesQuota()
    {
        // Arrange
    ...
    [Fact]
    public async Task SaveAiAgentQuotaSettings_DocSpaceAdmin_EnablesQuotaWithSize()
    {
        // Arrange
        var admin = await InviteContact(EmployeeType.DocSpaceAdmin);
        await _webApiClient.Authenticate(admin);
    ...
    [Fact]
    public async Task SaveAiAgentQuotaSettings_Anonymous_ThrowsUnauthorized()
    {
        // Arrange
    ...
    public async Task SaveAiAgentQuotaSettings_NonAdminMember_ThrowsAccessDenied(EmployeeType employeeType)
    {
        // Arrange
