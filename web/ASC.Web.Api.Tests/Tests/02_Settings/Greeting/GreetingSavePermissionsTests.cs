...
/// <summary>
/// POST /api/2.0/settings/greetingsettings — access control. Only a portal owner or a
/// DocSpaceAdmin may save a greeting title; every other role is denied, and an anonymous
/// caller is rejected before authorization is even evaluated.
/// </summary>
[Trait("Category", "Settings")]
public class GreetingSavePermissionsTests(
    AspireAppFixture fixture)
    : BaseTest(fixture)
{
    [Fact]
    public async Task SaveGreetingSettings_Anonymous_ThrowsUnauthorized()
    {
        // Arrange
    ...
    public async Task SaveGreetingSettings_NonAdminMember_ThrowsAccessDenied(EmployeeType employeeType)
    {
        // Arrange
    ...
    // Owner and DocSpaceAdmin success cases already exist in GreetingSaveTests.cs, commented
