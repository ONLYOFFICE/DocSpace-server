...
/// <summary>
/// POST /api/2.0/settings/notification — every authenticated role may enable/disable any
/// notification type for itself; the endpoint has no role restriction beyond being signed in.
/// </summary>
[Trait("Category", "Settings")]
public class NotificationSettingsSetTests(
    ...
    : NotificationsTestBase(fixture)
{
    ...
    public async Task SetNotificationSettings_AnyRole_EnablesTheType(NotificationActor actor, NotificationType type)
    {
        // Arrange
