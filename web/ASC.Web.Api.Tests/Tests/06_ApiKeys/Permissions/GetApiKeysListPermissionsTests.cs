...
/// <summary>
/// GET /api/2.0/keys — permission checks.
/// </summary>
[Trait("Category", "ApiKeys")]
public class GetApiKeysListPermissionsTests(
    ...
    : ApiKeysTestBase(fixture)
{
    ...
    public async Task GetApiKeys_Anonymous_ReturnsUnauthorized()
    {
        ...
        var exception = await Assert.ThrowsAsync<ApiException>(
            async () => await _apiKeysApi.GetApiKeysAsync(TestContext.Current.CancellationToken));
    ...
    [Trait("Bug", "81615")]
    [Fact]
    public async Task GetApiKeys_Guest_ReturnsForbidden()
    {
        // Arrange
        await _peopleClient.Authenticate(Owner);
        await _apiKeysApi.CreateApiKeyAsync(
