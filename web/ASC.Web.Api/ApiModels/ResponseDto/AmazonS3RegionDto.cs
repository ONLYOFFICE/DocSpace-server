...
/// </summary>
/// <remarks>
/// Mirrors what the AWS SDK's <c>RegionEndpoint</c> serialised to when the action returned it
/// directly, so the payload is unchanged - but the contract now names the fields instead of
/// leaning on a third-party type.
/// </remarks>
