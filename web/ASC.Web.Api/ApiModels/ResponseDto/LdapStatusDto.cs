...
public class LdapStatusDto : IMapFrom<LdapOperationStatus>
{
    ...
    /// </summary>
    [OpenApiDescription("Specifies if the LDAP operation is completed or not")]
    ...
    /// </summary>
    [OpenApiDescription("Percentage of completion")]
    public int Percents { get; set; }

    /// <summary>
    /// Certificate confirmation request
    /// </summary>
    [OpenApiDescription("Certificate confirmation request")]
    public string CertificateConfirmRequest { get; set; }

    /// <summary>
    /// Source
    /// </summary>
    [OpenApiDescription("Source")]
