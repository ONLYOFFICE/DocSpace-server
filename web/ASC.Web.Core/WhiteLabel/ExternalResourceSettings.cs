...
[Scope]
public class ExternalResourceSettings(ExternalResourceSettingsHelper helper, TenantExtraConfig tenantExtraConfig)
{
    public CultureSpecificExternalResources GetCultureSpecificExternalResources(CultureInfo culture = null, AdditionalWhiteLabelSettings whiteLabelSettings = null, bool isDocSpaceAdmin = false)
    {
        ...
        return new()
        {
            AdminPanel = tenantExtraConfig.Enterprise && isDocSpaceAdmin ? helper.AdminPanel.GetCultureSpecificExternalResource(culture) : null,
