...
[Scope]
public class SuspiciousLoginIntegrationEventHandler(
    SuspiciousLoginNotifier suspiciousLoginNotifier,
    TenantManager tenantManager,
    ILogger<SuspiciousLoginIntegrationEventHandler> logger)
    : IIntegrationEventHandler<SuspiciousLoginIntegrationEvent>
{
    public async Task Handle(SuspiciousLoginIntegrationEvent @event)
    {
