...
namespace ASC.Migrations.MySql.SaaS.Migrations
{
    ...
    [Migration("20260609131644_MigrationContext_Upgrade86")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASC.AI.Core.Database.Models.DbMcpServerState", b =>
                {
                    ...
                    b.HasKey("TenantId", "ServerId")
                        .HasName("PRIMARY");

                    b.ToTable("ai_mcp_server_states", (string)null);
            ...
            modelBuilder.Entity("ASC.AI.Core.Database.Models.DbRoomMcpServer", b =>
                {
                    ...
                    b.HasKey("TenantId", "RoomId", "ServerId")
                        .HasName("PRIMARY");
            ...
            modelBuilder.Entity("ASC.AI.Integration.Database.Models.DbAttachment", b =>
                {
                    b.Property<int>("TenantId")
                        .HasColumnType("int")
                        .HasColumnName("tenant_id");
                    ...
                    b.Property<string>("ThirdpartyEntryId")
                        .HasMaxLength(32)
                    ...
                    b.HasIndex("TenantId", "ThirdpartyEntryId")
                        .HasDatabaseName("IX_tenant_id_thirdparty_entry_id");

                    b.ToTable("ai_integration_attachments", (string)null);
            ...
            modelBuilder.Entity("ASC.AI.Integration.Database.Models.DbMessage", b =>
                {
                    b.Property<int>("TenantId")
                        .HasColumnType("int")
                        .HasColumnName("tenant_id");
            ...
            modelBuilder.Entity("ASC.AI.Integration.Database.Models.DbProfile", b =>
                {
                    ...
                    b.Property<bool?>("UseResponsesApi")
                        .HasColumnType("tinyint(1)")
                    ...
                    b.ToTable("ai_integration_profiles", (string)null);

                    b.HasAnnotation("MySql:CharSet", "utf8");
                });

            modelBuilder.Entity("ASC.AI.Integration.Database.Models.DbPrompt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
                    ...
                    b.HasIndex("TenantId", "CreatedBy", "FolderId")
                        .HasDatabaseName("IX_tenant_id_created_by_folder_id");

                    b.ToTable("ai_integration_prompts", (string)null);

                    b.HasAnnotation("MySql:CharSet", "utf8");
                });

            modelBuilder.Entity("ASC.AI.Integration.Database.Models.DbPromptFolder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
                    ...
                    b.ToTable("ai_integration_prompt_folders", (string)null);

                    b.HasAnnotation("MySql:CharSet", "utf8");
                });

            modelBuilder.Entity("ASC.AI.Integration.Database.Models.DbThread", b =>
                {
                    b.Property<int>("TenantId")
                        .HasColumnType("int")
                        .HasColumnName("tenant_id");
            ...
            modelBuilder.Entity("ASC.Core.Common.EF.Model.Ai.DbDefaultAiProvider", b =>
                {
                    ...
                    b.ToTable("ai_providers_default", (string)null);
            ...
            modelBuilder.Entity("ASC.Core.Common.EF.Model.DbTenantForbiden", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Address = "api-system-eu-central-1"
                        },
                        new
                        {
                            Address = "api-system-us-east-2"
                        },
                        new
                        {
                            Address = "identity-eu-central-1"
                        },
                        new
                        {
                            Address = "identity-us-east-2"
                        },
                        new
                        {
                            Address = "oauth"
            ...
            modelBuilder.Entity("ASC.Files.Core.EF.DbFileVectorization", b =>
                {
                    b.Property<int>("TenantId")
                        .HasColumnType("int")
                        .HasColumnName("tenant_id");
                    ...
                    b.ToTable("files_file_vectorization", (string)null);
            ...
            modelBuilder.Entity("ASC.Files.Core.EF.DbFilesGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("files_group", (string)null);
            ...
            modelBuilder.Entity("ASC.Files.Core.EF.DbFilesRoomGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ThirdpartyRoomId")
                        .HasMaxLength(200)
                        .HasColumnType("varchar")
                    ...
                    b.HasIndex("InternalRoomId")
                        .HasDatabaseName("idx_internal_room");

                    b.HasIndex("ThirdpartyRoomId")
                        .HasDatabaseName("idx_thirdparty_room");

                    b.HasIndex("TenantId", "GroupId", "InternalRoomId")
                        .IsUnique()
                        .HasDatabaseName("uq_roomgroup_internal");

                    b.HasIndex("TenantId", "GroupId", "ThirdpartyRoomId")
                        .IsUnique()
                        .HasDatabaseName("uq_roomgroup_thirdparty");

                    b.ToTable("files_roomgroup", (string)null);
            ...
            modelBuilder.Entity("ASC.Files.Core.EF.DbRoomSettings", b =>
                {
                    ...
                    b.Property<string>("ChatParameters")
                        .HasColumnType("json")
            ...
            modelBuilder.Entity("ASC.Files.Core.EF.DbThirdpartyFilesFormRoleMapping", b =>
                {
                    b.Property<int>("TenantId")
                        .HasColumnType("int")
                        .HasColumnName("tenant_id");
                    ...
                    b.ToTable("files_thirdparty_form_role_mapping", (string)null);

                    b.HasAnnotation("MySql:CharSet", "utf8");
                });

            modelBuilder.Entity("ASC.Files.Core.EF.DbThirdpartyRoomSettings", b =>
                {
                    b.Property<int>("TenantId")
                        .HasColumnType("int")
                        .HasColumnName("tenant_id");
                    ...
                    b.HasKey("TenantId", "HashId")
                        .HasName("primary");

                    b.ToTable("files_thirdparty_room_settings", (string)null);
            ...
            modelBuilder.Entity("ASC.Files.Core.EF.DbUserChatSettings", b =>
                {
                    ...
                    b.HasKey("TenantId", "RoomId", "UserId")
                        .HasName("PRIMARY");
                    ...
                    b.ToTable("ai_user_chat_settings", (string)null);
            ...
            modelBuilder.Entity("ASC.AI.Integration.Database.Models.DbAttachment", b =>
                {
                    ...
                    b.HasOne("ASC.AI.Integration.Database.Models.DbMessage", "Message")
                        .WithMany()
            ...
            modelBuilder.Entity("ASC.AI.Integration.Database.Models.DbMessage", b =>
                {
                    b.HasOne("ASC.AI.Integration.Database.Models.DbThread", "Thread")
                        .WithMany()
                        .HasForeignKey("TenantId", "ThreadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("ASC.AI.Integration.Database.Models.DbPrompt", b =>
                {
                    b.HasOne("ASC.AI.Integration.Database.Models.DbPromptFolder", "Folder")
                        .WithMany()
            ...
            modelBuilder.Entity("ASC.Files.Core.EF.DbFilesRoomGroup", b =>
                {
                    b.HasOne("ASC.Files.Core.EF.DbFilesGroup", "Group")
                        .WithMany()
