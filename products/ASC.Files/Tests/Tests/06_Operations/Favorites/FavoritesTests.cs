...
/// <summary>
/// GET /api/2.0/files/@root and folder listing - how the ancestor <see cref="FolderType"/> filter on
/// GET /api/2.0/files/{folderId} narrows the Favorites section to "My documents", a specific room
/// type or every room. This is a different axis from the item-kind <c>FilterType</c> covered by the
/// GET /api/2.0/files/@favorites suites.
/// </summary>
