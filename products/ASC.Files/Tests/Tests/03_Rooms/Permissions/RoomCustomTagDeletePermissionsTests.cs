...
public class RoomCustomTagDeletePermissionsTests(
    AspireAppFixture fixture)
    : RoomsPermissionsTestBase(fixture)
{
    /// <summary>
    /// Being invited to a room — with any access level — does not grant the right to delete a custom tag.
    /// </summary>
    [Theory]
    [MemberData(nameof(RoomAccessData.InvitedMemberAccesses), MemberType = typeof(RoomAccessData))]
    [Trait("Bug", "72499")]
    public async Task DeleteCustomTags_InvitedMember_Forbidden(EmployeeType employeeType, FileShare access)
    {
        // Arrange
