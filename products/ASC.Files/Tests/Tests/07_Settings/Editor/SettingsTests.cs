...
// NOTE: SetOpenEditorInSameTab, KeepNewFileName, HideConfirmCancelOperation, HideConfirmRoomLifetime,
// HideConfirmConvert, GetFilesSettings and GetFilesModule used to be covered here and now have their
// own dedicated test classes in this folder (ported from fileSettings.spec.ts /
// fileSettings.permissions.spec.ts with full functional + permission coverage). Everything below is
// outside that TS slice and stays as it was.
