...
/// <summary>
/// Shared setup for the file-version suites (change version history / restore version), both
/// functional and permission-focused.
/// </summary>
public abstract class VersionsTestBase(
