...
internal static partial class AutoCleanMyFolderServiceLogger
{
    ...
    public static partial void InfoFoundUsers(this ILogger<AutoCleanMyFolderService> logger, int count);

    [LoggerMessage(LogLevel.Information, "Waiting for data. Sleep {time}.")]
    public static partial void InfoWaitingForData(this ILogger<AutoCleanMyFolderService> logger, TimeSpan time);

    [LoggerMessage(LogLevel.Information, "Start clean up for user - {userId}")]
    public static partial void InfoCleanUp(this ILogger<AutoCleanMyFolderService> logger, int userId);

    [LoggerMessage(LogLevel.Information, "Finishclean up for user - {userId}")]
    public static partial void InfoCleanUpFinish(this ILogger<AutoCleanMyFolderService> logger, int userId);
}
