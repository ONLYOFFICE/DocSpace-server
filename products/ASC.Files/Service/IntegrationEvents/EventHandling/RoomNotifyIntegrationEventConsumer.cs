...
[Singleton]
public class RoomNotifyIntegrationEventConsumer(
    ILogger<RoomNotifyIntegrationEventConsumer> logger,
    IServiceScopeFactory serviceScopeFactory)
    : IConsumer<RoomNotifyIntegrationEvent>
{
    
    public async Task Consume(ConsumeContext<RoomNotifyIntegrationEvent> context)
    {
