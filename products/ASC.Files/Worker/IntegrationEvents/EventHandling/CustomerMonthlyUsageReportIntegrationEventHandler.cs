...
[Scope]
public class CustomerMonthlyUsageReportIntegrationEventHandler(
    ILogger<CustomerMonthlyUsageReportIntegrationEventHandler> logger,
    CommonLinkUtility commonLinkUtility,
    TenantManager tenantManager,
    DocumentBuilderTaskManager<CustomerMonthlyUsageReportTask, int, CustomerMonthlyUsageReportTaskData> documentBuilderTaskManager,
    IServiceProvider serviceProvider)
    : IIntegrationEventHandler<CustomerMonthlyUsageReportIntegrationEvent>
{

    public async Task Handle(CustomerMonthlyUsageReportIntegrationEvent @event)
    {
