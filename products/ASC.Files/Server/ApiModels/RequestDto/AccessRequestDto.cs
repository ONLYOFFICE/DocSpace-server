...
public static partial class AccessRequestKeyDtoMapper
{
    public static partial IEnumerable<FileKeyData> Project(this IEnumerable<AccessRequestKeyDto> source);
}
