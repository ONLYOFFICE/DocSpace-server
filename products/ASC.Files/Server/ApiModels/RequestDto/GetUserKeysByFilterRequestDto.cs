...
/// <summary>
/// The request parameters for filtering user encryption keys.
/// </summary>
public class GetUserKeysByFilterRequestDto
{
    /// <summary>
    ...
    /// </summary>
    /// <example>some public key</example>
    ...
    /// </summary>
    /// <example>some encrypted private key</example>
    [FromQuery(Name = "privateKeyEnc")]
