...
public interface ISecurityDao<T>
{
    ...
    IAsyncEnumerable<UserInfoWithShared> GetUsersWithSharedAsync(FileEntry<T> entry, string text, EmployeeStatus? employeeStatus, EmployeeActivationStatus? activationStatus, bool excludeShared, string separator, bool excludeStrangers, Area area, int offset = 0, int count = -1);
    Task<int> GetUsersWithSharedCountAsync(FileEntry<T> entry, string text, EmployeeStatus? employeeStatus, EmployeeActivationStatus? activationStatus, bool excludeShared, string separator, bool excludeStrangers, Area area);
