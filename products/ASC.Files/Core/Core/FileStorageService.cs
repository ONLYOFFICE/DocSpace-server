...
(Global global,
    ...
    public async Task<Folder<int>> CreateRoomAsync(string title, RoomType roomType, bool @private, bool indexing)
    {
    ...
    public async Task<Folder<T>> CreateThirdPartyRoomAsync<T>(string title, RoomType roomType, T parentId, bool @private, bool indexing)
    {
        ArgumentNullException.ThrowIfNull(title);
        ArgumentNullException.ThrowIfNull(parentId);
