...
/// <summary>
/// Legacy `ai_user_chat_settings` row. Schema-only: the pre-ASC.AI.Chat chat stack is gone and nothing reads this. Registered in MigrationContext so the table survives.
/// </summary>
