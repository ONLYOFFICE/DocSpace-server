...
/// <summary>
/// Legacy `ai_user_chat_settings` row. Schema-only: the pre-ASC.NewAi chat stack is gone and nothing reads this. Registered in MigrationContext so the table survives.
/// </summary>
