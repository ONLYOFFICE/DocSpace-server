...
public class DbThirdpartyFilesFormRoleMapping : BaseEntity, IDbFile
{
...
public static class DbThirdpartyFilesFormRoleMappingExtension
{
    public static ModelBuilderWrapper AddDbThirdpartyFilesFormRoleMapping(this ModelBuilderWrapper modelBuilder)
    {
        modelBuilder.Entity<DbThirdpartyFilesFormRoleMapping>().Navigation(e => e.Tenant).AutoInclude(false);
    ...
    extension(ModelBuilder modelBuilder)
    {
        ...
        {
            modelBuilder.Entity<DbThirdpartyFilesFormRoleMapping>(entity =>
            {
                entity.HasKey(e => new { e.TenantId, e.FormId, e.RoleName, e.UserId })
                    .HasName("PRIMARY");

                entity.ToTable("files_thirdparty_form_role_mapping")
                    .HasCharSet("utf8");
        ...
        public void PgSqlAddDbFilesFormRoleMapping()
        {
            ...
            {
                entity.HasKey(e => new { e.TenantId, e.FormId, e.RoleName, e.UserId })
                    .HasName("files_thirdparty_form_role_mapping_pkey");

                entity.ToTable("files_thirdparty_form_role_mapping", "onlyoffice");
