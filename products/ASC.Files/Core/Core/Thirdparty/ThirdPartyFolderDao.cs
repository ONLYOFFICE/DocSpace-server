    ...
    where TItem : class
{
    ...
    public Task<IDictionary<string, TTo>> CanMoveOrCopyAsync<TTo>(IEnumerable<string> folderIds, string to)
    {
        throw new NotImplementedException();
    }
    ...
    public Task<IDictionary<string, TTo>> CanMoveOrCopyAsync<TTo>(IEnumerable<string> folderIds, int to)
    {
        throw new NotImplementedException();
    }
}
