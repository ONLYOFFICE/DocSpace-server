    ...
    VectorizationGlobalSettings vectorizationGlobalSettings)
{
    ...
    {
        var providerType = EmbeddingProviderType.None;
...
#pragma warning restore SCME0001
                ...
                var innerGenerator = MakeGenerator(key, gateway.Url, vectorizationGlobalSettings.Model.Id);

                return new InternalEmbeddingGenerator(innerGenerator, generationOptions);
            case EmbeddingProviderType.OpenAi:
                return MakeGenerator(key, VectorizationGlobalSettings.OpenAiBaseUrl, vectorizationGlobalSettings.Model.Id);
            case EmbeddingProviderType.OpenRouter:
                return MakeGenerator(key, VectorizationGlobalSettings.OpenRouterBaseUrl, $"openai/{vectorizationGlobalSettings.Model.Id}");
