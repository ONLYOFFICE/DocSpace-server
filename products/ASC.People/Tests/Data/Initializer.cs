...
public static class Initializer
{
    ...
    public static async Task InitializeAsync(PeopleFactory peopleFactory, WepApiFactory apiFactory)
    {
        _passwordHasher = peopleFactory.Services.GetRequiredService<PasswordHasher>();
        ...
        if (!_initialized)
        {
            await peopleFactory.BackupTables();
        }
