...
[Singleton]
public class VectorsDeletionProcessingService(
    IServiceScopeFactory serviceScopeFactory,
    ILogger<VectorsDeletionProcessingService> logger,
    ChannelReader<VectorsDeletionIntegrationEvent> channelReader)
    : BackgroundService
{
    ...
    private async Task ProcessEventAsync(VectorsDeletionIntegrationEvent @event, CancellationToken cancellationToken)
    {
