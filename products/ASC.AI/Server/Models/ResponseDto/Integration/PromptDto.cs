...
{
    public static partial PromptDto MapToDto(Prompt prompt);

    public static PromptCreateData MapToCreateData(CreatePromptRequestDto dto) => new(dto.Name, dto.Text, dto.FolderId);
