...
{
    public static async Task StreamSentEventAsync(
        ...
        CancellationToken cancellationToken)
    {
        ...
        controller.Response.Headers.KeepAlive = "keep-alive";
        ...
        var mainTask = Task.Run(async () =>
        {
            try
            {
                await foreach (var content in source.WithCancellation(cancellationToken))
                {
        ...
        {
            await controller.Response.WriteAsync(content, cancellationToken);
            await controller.Response.Body.FlushAsync(cancellationToken);
        }
