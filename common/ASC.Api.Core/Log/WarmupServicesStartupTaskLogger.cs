...
internal static partial class WarmupServicesStartupTaskLogger
{
    ...
    [LoggerMessage(Level = LogLevel.Trace, Message = "Service:{fullName},time:{totalMilliseconds}")]
    ...
    [LoggerMessage(Level = LogLevel.Debug, Message = "#{index} Failed proccessed {serviceTitle} service")]
