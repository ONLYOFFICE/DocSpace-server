...
public class InternalRouteAttribute : RouteAttribute
{
    ...
    static InternalRouteAttribute()
    {
        BaseUrl = "internal/[controller]";
    }

    public InternalRouteAttribute() : base(BaseUrl) { }
    public InternalRouteAttribute(string template) : base($"{BaseUrl}/{template}") { }
}
