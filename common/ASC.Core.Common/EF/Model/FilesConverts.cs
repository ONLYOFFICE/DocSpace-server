...
public static class FilesConvertsExtension
{
    public static ModelBuilderWrapper AddFilesConverts(this ModelBuilderWrapper modelBuilder)
    {
        modelBuilder
           ...
           new FilesConverts { Input = ".hwp", Output = ".docx" },
           new FilesConverts { Input = ".hwp", Output = ".odt" },
           new FilesConverts { Input = ".hwp", Output = ".pdf" },
           new FilesConverts { Input = ".hwp", Output = ".rtf" },
           new FilesConverts { Input = ".hwp", Output = ".txt" },
           new FilesConverts { Input = ".hwp", Output = ".docm" },
           new FilesConverts { Input = ".hwp", Output = ".dotm" },
           new FilesConverts { Input = ".hwp", Output = ".dotx" },
           new FilesConverts { Input = ".hwp", Output = ".epub" },
           new FilesConverts { Input = ".hwp", Output = ".fb2" },
           new FilesConverts { Input = ".hwp", Output = ".html" },
           new FilesConverts { Input = ".hwp", Output = ".ott" },
           new FilesConverts { Input = ".hwpx", Output = ".docx" },
           new FilesConverts { Input = ".hwpx", Output = ".odt" },
           new FilesConverts { Input = ".hwpx", Output = ".pdf" },
           new FilesConverts { Input = ".hwpx", Output = ".rtf" },
           new FilesConverts { Input = ".hwpx", Output = ".txt" },
           new FilesConverts { Input = ".hwpx", Output = ".docm" },
           new FilesConverts { Input = ".hwpx", Output = ".dotm" },
           new FilesConverts { Input = ".hwpx", Output = ".dotx" },
           new FilesConverts { Input = ".hwpx", Output = ".epub" },
           new FilesConverts { Input = ".hwpx", Output = ".fb2" },
           new FilesConverts { Input = ".hwpx", Output = ".html" },
           new FilesConverts { Input = ".hwpx", Output = ".ott" },

           new FilesConverts { Input = ".key", Output = ".odp" },
           new FilesConverts { Input = ".key", Output = ".pdf" },
           new FilesConverts { Input = ".key", Output = ".pptx" },
           new FilesConverts { Input = ".key", Output = ".otp" },
           new FilesConverts { Input = ".key", Output = ".potm" },
           new FilesConverts { Input = ".key", Output = ".potx" },
           new FilesConverts { Input = ".key", Output = ".ppsm" },
           new FilesConverts { Input = ".key", Output = ".ppsx" },
           new FilesConverts { Input = ".key", Output = ".pptm" },

           new FilesConverts { Input = ".md", Output = ".docx" },
           new FilesConverts { Input = ".md", Output = ".odt" },
           new FilesConverts { Input = ".md", Output = ".pdf" },
           new FilesConverts { Input = ".md", Output = ".rtf" },
           new FilesConverts { Input = ".md", Output = ".txt" },
           new FilesConverts { Input = ".md", Output = ".docm" },
           new FilesConverts { Input = ".md", Output = ".dotm" },
           new FilesConverts { Input = ".md", Output = ".dotx" },
           new FilesConverts { Input = ".md", Output = ".epub" },
           new FilesConverts { Input = ".md", Output = ".fb2" },
           new FilesConverts { Input = ".md", Output = ".html" },
           new FilesConverts { Input = ".md", Output = ".ott" },
           ...
           new FilesConverts { Input = ".numbers", Output = ".csv" },
           new FilesConverts { Input = ".numbers", Output = ".ods" },
           new FilesConverts { Input = ".numbers", Output = ".pdf" },
           new FilesConverts { Input = ".numbers", Output = ".xlsx" },
           new FilesConverts { Input = ".numbers", Output = ".xlsm" },
           new FilesConverts { Input = ".numbers", Output = ".xltm" },
           new FilesConverts { Input = ".numbers", Output = ".xltx" },
           new FilesConverts { Input = ".numbers", Output = ".ots" },

           new FilesConverts { Input = ".odg", Output = ".odp" },
           new FilesConverts { Input = ".odg", Output = ".pdf" },
           new FilesConverts { Input = ".odg", Output = ".pptx" },
           new FilesConverts { Input = ".odg", Output = ".otp" },
           new FilesConverts { Input = ".odg", Output = ".potm" },
           new FilesConverts { Input = ".odg", Output = ".potx" },
           new FilesConverts { Input = ".odg", Output = ".ppsm" },
           new FilesConverts { Input = ".odg", Output = ".ppsx" },
           new FilesConverts { Input = ".odg", Output = ".pptm" },
           ...
           new FilesConverts { Input = ".pages", Output = ".docm" },
           new FilesConverts { Input = ".pages", Output = ".docx" },
           new FilesConverts { Input = ".pages", Output = ".dotm" },
           new FilesConverts { Input = ".pages", Output = ".dotx" },
           new FilesConverts { Input = ".pages", Output = ".epub" },
           new FilesConverts { Input = ".pages", Output = ".fb2" },
           new FilesConverts { Input = ".pages", Output = ".html" },
           new FilesConverts { Input = ".pages", Output = ".odt" },
           new FilesConverts { Input = ".pages", Output = ".ott" },
           new FilesConverts { Input = ".pages", Output = ".pdf" },
           new FilesConverts { Input = ".pages", Output = ".rtf" },
           new FilesConverts { Input = ".pages", Output = ".txt" },
           ...
           new FilesConverts { Input = ".vsdm", Output = ".bmp" },
           new FilesConverts { Input = ".vsdm", Output = ".gif" },
           new FilesConverts { Input = ".vsdm", Output = ".jpg" },
           new FilesConverts { Input = ".vsdm", Output = ".pdf" },
           new FilesConverts { Input = ".vsdm", Output = ".pdfa" },
           new FilesConverts { Input = ".vsdm", Output = ".png" },
           new FilesConverts { Input = ".vsdx", Output = ".bmp" },
           new FilesConverts { Input = ".vsdx", Output = ".gif" },
           new FilesConverts { Input = ".vsdx", Output = ".jpg" },
           new FilesConverts { Input = ".vsdx", Output = ".pdf" },
           new FilesConverts { Input = ".vsdx", Output = ".pdfa" },
           new FilesConverts { Input = ".vsdx", Output = ".png" },
           new FilesConverts { Input = ".vssm", Output = ".bmp" },
           new FilesConverts { Input = ".vssm", Output = ".gif" },
           new FilesConverts { Input = ".vssm", Output = ".jpg" },
           new FilesConverts { Input = ".vssm", Output = ".pdf" },
           new FilesConverts { Input = ".vssm", Output = ".pdfa" },
           new FilesConverts { Input = ".vssm", Output = ".png" },
           new FilesConverts { Input = ".vssx", Output = ".bmp" },
           new FilesConverts { Input = ".vssx", Output = ".gif" },
           new FilesConverts { Input = ".vssx", Output = ".jpg" },
           new FilesConverts { Input = ".vssx", Output = ".pdf" },
           new FilesConverts { Input = ".vssx", Output = ".pdfa" },
           new FilesConverts { Input = ".vssx", Output = ".png" },
           new FilesConverts { Input = ".vstm", Output = ".bmp" },
           new FilesConverts { Input = ".vstm", Output = ".gif" },
           new FilesConverts { Input = ".vstm", Output = ".jpg" },
           new FilesConverts { Input = ".vstm", Output = ".pdf" },
           new FilesConverts { Input = ".vstm", Output = ".pdfa" },
           new FilesConverts { Input = ".vstm", Output = ".png" },
           new FilesConverts { Input = ".vstx", Output = ".bmp" },
           new FilesConverts { Input = ".vstx", Output = ".gif" },
           new FilesConverts { Input = ".vstx", Output = ".jpg" },
           new FilesConverts { Input = ".vstx", Output = ".pdf" },
           new FilesConverts { Input = ".vstx", Output = ".pdfa" },
           new FilesConverts { Input = ".vstx", Output = ".png" },
