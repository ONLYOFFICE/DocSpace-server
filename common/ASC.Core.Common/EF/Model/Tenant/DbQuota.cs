        ...
        modelBuilder
            .HasData(
                new DbQuota
                {
                    ...
                    Name = "trial",
                    Description = null,
                    Features = "trial,audit,ldap,sso,whitelabel,customization,thirdparty,restore,oauth,total_size:107374182400,file_size:100,manager:1,statistic",
                    Price = 0,
                    ProductId = null,
                    Visible = false
                },
                new DbQuota
                {
                    ...
                    Features = "audit,ldap,sso,whitelabel,customization,thirdparty,restore,oauth,contentsearch,total_size:107374182400,file_size:1024,manager:1,statistic",
                    Price = 15,
                    ProductId = "1002",
                    Visible = false
                },
                ...
                new DbQuota
                {
                    ...
                    Name = "subscription",
                    Description = null,
                    Features = "audit,ldap,sso,whitelabel,customization,thirdparty,restore,oauth,contentsearch,file_size:1024,statistic",
                    Price = 0,
                    ProductId = "1001",
                    Visible = false
                },
                ...
                new DbQuota
                {
                    ...
                    Features = "audit,ldap,sso,whitelabel,customization,thirdparty,restore,oauth,contentsearch,total_size:268435456000,file_size:1024,manager:1,statistic",
                    Price = 20,
                    ProductId = "1006",
                    Visible = true
                }
