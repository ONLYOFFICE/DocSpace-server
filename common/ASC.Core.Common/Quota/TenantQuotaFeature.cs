...
{
    public TenantQuotaFeatureCount(TenantQuota tenantQuota, string name, bool paid = false)
        : base(tenantQuota, name, int.MaxValue, paid)
    {
    }

    public TenantQuotaFeatureCount(TenantQuota tenantQuota, string name, int @default, bool paid = false)
        : base(tenantQuota, name, @default, paid)
    {
    }
