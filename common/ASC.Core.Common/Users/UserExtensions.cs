...
public static class UserExtensions
{
    ...
    public static Task<bool> IsDocSpaceAdminAsync(this UserManager userManager, UserInfo ui)
    {
    ...
    public static Task<bool> IsGuestAsync(this UserManager userManager, UserInfo ui)
    {
    ...
    public static Task<bool> IsUserAsync(this UserManager userManager, UserInfo userInfo)
    {
    ...
    public static Task<bool> IsOutsiderAsync(this UserManager userManager, UserInfo ui)
    {
    ...
    public static Task<EmployeeType> GetUserTypeAsync(this UserManager userManager, UserInfo user)
    {
        return userManager.GetUserTypeAsync(user.Id);
    }

    public static async Task<bool> CanUserViewAnotherUserAsync(this UserManager userManager, Guid sourceUserId, Guid targetUserId)
    {
