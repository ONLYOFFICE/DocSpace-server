...
public enum MessageAction
{
    ...
    [Description("Customer AI balance topped up")]
    CustomerAiToppedUp = 6099,

    [Description("Customer AI auto top up settings updated")]
    CustomerAiAutoTopUpSettingsUpdated = 6100,
