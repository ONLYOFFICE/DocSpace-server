...
import com.asc.authorization.api.core.exceptions.DistributedRateLimiterException;
...
public class DistributedRateLimiterAspect {
     ...
     * @throws Throwable
     */
    @Around("@annotation(com.asc.authorization.api.extensions.annotations.DistributedRateLimiter)")
