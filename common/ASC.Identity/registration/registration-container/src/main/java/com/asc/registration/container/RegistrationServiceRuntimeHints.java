...
/** Registers native image resources required for startup logging configuration. */
public class RegistrationServiceRuntimeHints implements RuntimeHintsRegistrar {
