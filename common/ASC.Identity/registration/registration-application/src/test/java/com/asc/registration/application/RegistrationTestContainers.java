...
public final class RegistrationTestContainers {
    ...
    public static void configureRabbitMq(DynamicPropertyRegistry registry, RabbitMQContainer rabbitmq) {
    ...
    public static void configureDynamoDb(DynamicPropertyRegistry registry, LocalStackContainer localstack) {
