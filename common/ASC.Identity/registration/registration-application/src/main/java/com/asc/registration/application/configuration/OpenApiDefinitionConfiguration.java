...
/**
 * Carries the document-level OpenAPI metadata for the registration service.
 *
 * <p>It lives in this module rather than on the application class in registration-container so that
 * every route that builds the document sees it: the documentation test boots its own application
 * class inside this module and never scans the container.
 */
@Configuration
@OpenAPIDefinition(
    info =
