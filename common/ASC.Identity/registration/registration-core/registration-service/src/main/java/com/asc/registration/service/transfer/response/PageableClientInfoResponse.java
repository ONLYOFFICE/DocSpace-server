...
/**
 * OpenAPI companion for {@link PageableResponse}{@code <ClientInfoResponse>}. Declares {@code data}
 * as an array of {@link ClientInfoResponse} so generators are not left with an untyped page payload
 * after generic erasure.
 */
@Getter
@Setter
@Builder
...
@AllArgsConstructor
@Schema(
    name = "PageableClientInfoResponse",
    description = "One page of consent-facing client info together with the next-page cursor.")
public class PageableClientInfoResponse {
  @ArraySchema(
  ...
  private List<ClientInfoResponse> data;
