...
package com.asc.authorization.application.security.oauth.authentications;
...
/** Authentication token for Personal Access Token authorization grant. */
@Getter
public class PersonalAccessTokenAuthenticationToken
  ...
  public PersonalAccessTokenAuthenticationToken(
    ...
    super(AscAuthorizationGrantType.PERSONAL_ACCESS_TOKEN, clientPrincipal, additionalParameters);
    this.scopes =
