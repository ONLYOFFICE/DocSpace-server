package com.onlyoffice.authorization.external.extensions.aspects;

import com.onlyoffice.authorization.core.exceptions.DistributedRateLimiterException;
import com.onlyoffice.authorization.external.extensions.annotations.DistributedRateLimiter;
...
public class DistributedRateLimiterAspect {
    ...
    @Around("@annotation(com.onlyoffice.authorization.external.extensions.annotations.DistributedRateLimiter)")
