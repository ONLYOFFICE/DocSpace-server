...
[Scope]
public class BackupRequestedIntegrationEventConsumer(
        BackupAjaxHandler backupAjaxHandler,
        ILogger<BackupRequestedIntegrationEventConsumer> logger,
        TenantManager tenantManager,
        SecurityContext securityContext,
        BackupWorker backupWorker)
    : IConsumer<BackupRequestIntegrationEvent>
{
    public async Task Consume(ConsumeContext<BackupRequestIntegrationEvent> context)
    {
