...
public class PluginContextManager
{
    ...
    private readonly Dictionary<string, PluginLoadContext> _pluginContexts = new Dictionary<string, PluginLoadContext>();
    ...
    public List<PluginLoadContext> All()
    {
    ...
    public PluginLoadContext Get(string pluginId)
    {
        return _pluginContexts[pluginId];
    }

    public void Add(string pluginId, PluginLoadContext context)
    {
