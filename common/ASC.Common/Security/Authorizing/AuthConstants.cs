...
public static class AuthConstants
{
    ...
    public static readonly Role Collaborator = new(new Guid("88f11e7c-7407-4bea-b4cb-070010cdbb6b"), "Collaborator");
    public static readonly Role User = new(new Guid("aced04fa-dd96-4b35-af3e-346bf1eb972d"), "User");
