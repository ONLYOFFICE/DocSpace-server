...
/// <summary>
/// The Enterprise licence warning <c>enterprise_admin_payment_warning_grace_period_expiration</c>, sent to the portal admins.
/// </summary>
public class EnterpriseAdminPaymentWarningGracePeriodExpirationLetterTests : LetterTestBase
{
    ...
    protected override string LetterId => "enterprise_admin_payment_warning_grace_period_expiration";

    protected override IPattern Pattern => new EmailPattern(
        () => WebstudioNotifyPatternResource.subject_enterprise_admin_payment_warning_grace_period_expiration,
        () => WebstudioNotifyPatternResource.pattern_enterprise_admin_payment_warning_grace_period_expiration);
    ...
    protected override void AssertDefaultCultureText(RenderedLetter letter)
    {
        ...
        letter.Subject.Should().Be($"Your {logoText} Enterprise no longer available");

        letter.Body.Should().Contain($"Hello, {RecipientName}!")
            .And.Contain($"The grace period for your {logoText} Enterprise license expires today");
