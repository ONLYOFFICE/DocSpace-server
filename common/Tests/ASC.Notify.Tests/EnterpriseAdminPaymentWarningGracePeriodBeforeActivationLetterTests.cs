...
/// </summary>
public class EnterpriseAdminPaymentWarningGracePeriodBeforeActivationLetterTests : LetterTestBase<EnterpriseAdminPaymentWarningGracePeriodBeforeActivationNotifyAction>
{
