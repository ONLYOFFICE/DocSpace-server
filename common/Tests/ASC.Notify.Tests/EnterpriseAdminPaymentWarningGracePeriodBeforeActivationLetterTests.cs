...
/// <summary>
/// The Enterprise licence warning <c>enterprise_admin_payment_warning_grace_period_before_activation</c>, sent to the portal admins.
/// </summary>
public class EnterpriseAdminPaymentWarningGracePeriodBeforeActivationLetterTests : LetterTestBase
{
    ...
    protected override string LetterId => "enterprise_admin_payment_warning_grace_period_before_activation";

    protected override IPattern Pattern => new EmailPattern(
        () => WebstudioNotifyPatternResource.subject_enterprise_admin_payment_warning_grace_period_before_activation,
        () => WebstudioNotifyPatternResource.pattern_enterprise_admin_payment_warning_grace_period_before_activation);
    ...
    protected override void AssertDefaultCultureText(RenderedLetter letter)
    {
        ...
        letter.Subject.Should().Be($"Your {logoText} Enterprise license will expire soon");

        letter.Body.Should().Contain($"Hello, {RecipientName}!")
            .And.Contain($"Your license for {logoText} Enterprise will expire in 7 days");
