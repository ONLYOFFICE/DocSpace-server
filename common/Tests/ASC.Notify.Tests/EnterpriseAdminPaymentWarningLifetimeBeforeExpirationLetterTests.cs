...
/// <summary>
/// The Enterprise licence warning <c>enterprise_admin_payment_warning_lifetime_before_expiration</c>, sent to the portal admins.
/// </summary>
public class EnterpriseAdminPaymentWarningLifetimeBeforeExpirationLetterTests : LetterTestBase
{
    ...
    protected override string LetterId => "enterprise_admin_payment_warning_lifetime_before_expiration";

    protected override IPattern Pattern => new EmailPattern(
        () => WebstudioNotifyPatternResource.subject_enterprise_admin_payment_warning_lifetime_before_expiration,
        () => WebstudioNotifyPatternResource.pattern_enterprise_admin_payment_warning_lifetime_before_expiration);
