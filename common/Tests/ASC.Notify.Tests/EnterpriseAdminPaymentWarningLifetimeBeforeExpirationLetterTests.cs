...
/// </summary>
public class EnterpriseAdminPaymentWarningLifetimeBeforeExpirationLetterTests : LetterTestBase<EnterpriseAdminPaymentWarningLifetimeBeforeExpirationNotifyAction>
{
