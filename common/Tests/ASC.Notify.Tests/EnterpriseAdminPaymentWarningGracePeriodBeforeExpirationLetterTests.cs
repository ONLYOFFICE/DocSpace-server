...
/// </summary>
public class EnterpriseAdminPaymentWarningGracePeriodBeforeExpirationLetterTests : LetterTestBase<EnterpriseAdminPaymentWarningGracePeriodBeforeExpirationNotifyAction>
{
