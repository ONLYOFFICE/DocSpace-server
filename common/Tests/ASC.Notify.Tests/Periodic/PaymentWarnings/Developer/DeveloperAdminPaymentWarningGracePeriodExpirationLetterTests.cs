...
/// </summary>
public class DeveloperAdminPaymentWarningGracePeriodExpirationLetterTests : PeriodicLetterTestBase<DeveloperAdminPaymentWarningGracePeriodExpirationNotifyAction>
{
    ...
    protected override void AssertDefaultCultureText(RenderedLetter letter, LetterScope scope)
    {
        ...
        letter.Subject.Should().Be($"Your {logoText} Developer no longer available");

        letter.Body.Should().Contain($"Hello, {scope.Recipient.FirstName}!")
            .And.Contain($"The grace period for your {logoText} Developer license expires today");
