...
/// </summary>
public class EnterpriseAdminPaymentWarningLifetimeExpirationLetterTests : PeriodicLetterTestBase<EnterpriseAdminPaymentWarningLifetimeExpirationNotifyAction>
{
