...
/// </summary>
public class DeveloperAdminPaymentWarningGracePeriodBeforeActivationLetterTests : LetterTestBase<DeveloperAdminPaymentWarningGracePeriodBeforeActivationNotifyAction>
{
