...
/// <summary>
/// The Developer licence warning <c>developer_admin_payment_warning_grace_period_before_activation</c>, sent to the portal admins.
/// </summary>
public class DeveloperAdminPaymentWarningGracePeriodBeforeActivationLetterTests : LetterTestBase
{
    ...
    protected override string LetterId => "developer_admin_payment_warning_grace_period_before_activation";

    protected override IPattern Pattern => new EmailPattern(
        () => WebstudioNotifyPatternResource.subject_developer_admin_payment_warning_grace_period_before_activation,
        () => WebstudioNotifyPatternResource.pattern_developer_admin_payment_warning_grace_period_before_activation);
    ...
    protected override void AssertDefaultCultureText(RenderedLetter letter)
    {
        ...
        letter.Subject.Should().Be($"Your {logoText} Developer license will expire soon");

        letter.Body.Should().Contain($"Hello, {RecipientName}!")
            .And.Contain($"Your license for {logoText} Developer will expire in 7 days");
