...
/// </summary>
public class UserRoleChangedLetterTests : LetterTestBase
{
    ...
    protected override string LetterId => "user_role_changed";

    protected override IPattern Pattern => new EmailPattern(
        () => WebstudioNotifyPatternResource.subject_user_role_changed,
        () => WebstudioNotifyPatternResource.pattern_user_role_changed);
