...
export const ENGINE_DOCS: ReadonlyArray<EngineDoc> = [
  {
    name: "ai",
    tag: "AI",
    description: "Chat completions and tool-call approval.",
    routes: DEFAULT_AI_ROUTES,
  },
  {
    name: "assignments",
    tag: "Assignments",
    description: "Profile-to-entity assignment resolution.",
    routes: DEFAULT_ASSIGNMENTS_ROUTES,
  },
  {
    name: "attachments",
    tag: "Attachments",
  ...
  },
  {
    name: "profiles",
    tag: "Profiles",
    description: "AI provider profiles and model discovery.",
    routes: DEFAULT_PROFILES_ROUTES,
  },
  {
    name: "prompts",
    tag: "Prompts",
    description: "Saved prompts and prompt folders.",
    routes: DEFAULT_PROMPTS_ROUTES,
  },
  {
    name: "threads",
    tag: "Threads",
    description: "Chat threads and their messages.",
    routes: DEFAULT_THREADS_ROUTES,
  },
  {
    name: "tools",
    tag: "Tools",
    description: "MCP custom servers and system tool preferences.",
    routes: DEFAULT_TOOLS_ROUTES,
  },
  {
    name: "webSearch",
    tag: "Web search",
    description: "Web-search provider configuration.",
    routes: DEFAULT_WEB_SEARCH_ROUTES,
  },
];
...
export const CUSTOM_ROUTE_DOCS: ReadonlyArray<CustomRouteDoc> = [
  ...
  {
    method: "PUT",
    path: "/agents/agentquota",
    tag: "Agents",
    operationId: "aiAgentsUpdateQuota",
    summary: "Update agents' quota",
    hasBody: true,
  },
  {
    method: "PUT",
    path: "/agents/resetquota",
    tag: "Agents",
    operationId: "aiAgentsResetQuota",
  ...
  },
  {
    ...
    path: "/config",
    tag: "Settings",
    operationId: "aiSettingsGet",
    summary: "Get AI settings",
  },
  {
    method: "GET",
    path: "/config/vectorization",
    tag: "Settings",
    operationId: "aiSettingsGetVectorization",
  ...
  },
  {
    ...
    path: "/config/vectorization",
    tag: "Settings",
    operationId: "aiSettingsSetVectorization",
  ...
  },
  {
    ...
    tag: "Vectorization",
    operationId: "aiVectorizationStartTask",
    summary: "Start a vectorization task",
    hasBody: true,
  },
  {
    method: "POST",
    path: "/openai/{profileId}/v1/chat/completions",
    tag: "OpenAI passthrough",
    operationId: "aiOpenaiChatCompletions",
  ...
  {
    method: "POST",
    path: "/openai/{profileId}/v1/images/generations",
    tag: "OpenAI passthrough",
    operationId: "aiOpenaiImagesGenerations",
  ...
  {
    method: "GET",
    path: "/editor-tools/list",
    tag: "Editor tools",
    operationId: "aiEditorToolsList",
    summary: "List editor tools",
  },
  {
    method: "POST",
    path: "/editor-tools/call",
    tag: "Editor tools",
    operationId: "aiEditorToolsCall",
    summary: "Call an editor tool",
    hasBody: true,
  },
  {
    method: "POST",
    path: "/websearch/v1/search",
    tag: "Web search",
    operationId: "aiWebSearchPassthroughSearch",
    summary: "Web search passthrough",
    hasBody: true,
  },
  {
    method: "POST",
    path: "/websearch/v1/contents",
    tag: "Web search",
    operationId: "aiWebSearchPassthroughContents",
