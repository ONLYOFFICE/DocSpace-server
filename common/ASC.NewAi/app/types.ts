...
export interface RequestContext {
  ...
  // The attachment id resolvedFormId came from — the analyze-intent key.
  ...
  // Entry ids of forms attached for analysis (per-file analyzeOnly); read by createMany.
  analyzeEntryIds?: string[];
