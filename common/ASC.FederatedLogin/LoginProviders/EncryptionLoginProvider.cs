    ...
    AccountLinker accountLinker)
{
    ...
    public async Task ThrowIfKeysAreNotSetAsync(Guid userId)
    {
        if (await GetKeysAsync(userId) == null)
        {
            throw new InvalidOperationException($"The user does not have an encryption key");
        }
    }
}
