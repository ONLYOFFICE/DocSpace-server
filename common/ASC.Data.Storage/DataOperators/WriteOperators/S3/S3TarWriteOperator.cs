...
public class S3TarWriteOperator : IDataWriteOperator
{
    ...
    public S3TarWriteOperator(CommonChunkedUploadSession chunkedUploadSession, CommonChunkedUploadSessionHolder sessionHolder, TempStream tempStream, AscHybridCache cache)
    {
