...
public interface IDataStore
{
    ...
    /// <param name="stream"></param>
    /// <param name="attachmentFileName"></param>
    /// <param name="allowQuotaGrace"></param>
    /// <param name="token"></param>
    /// <returns></returns>
    Task<Uri> SaveAsync(string domain, string path, Guid ownerId, Stream stream, string attachmentFileName, bool allowQuotaGrace = false, CancellationToken token = default);
